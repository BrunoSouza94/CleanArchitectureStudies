...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20240418095253_unique_identityid_user")]
    partial class unique_identityid_user
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Entities.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Entities.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Entities.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Entities.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Entities.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Entities.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Entities.Shared.Money", "Total", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Entities.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
